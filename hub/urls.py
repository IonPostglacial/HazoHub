...
urlpatterns = [
    ...
    path('summary/<str:file_name>/export-csv', views.dataset.summary_csv, name="summarycsv"),
    ...
    path('identify/<str:file_name>/characters-list', views.characters.list_view, name="charlist"),
    path('identify/<str:file_name>/characters-list/<int:in_character>', views.characters.list_view, name="charlistin"),
    path('identify/<str:file_name>/characters-states-list/<int:in_character>', views.characters.states_list, name="charstateslist"),
    path('api/datasets', views.dataset.api_post_dataset, name="postdataset"),
